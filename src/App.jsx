    ...
    <div>
      ...
      {(state.timeRemaining <= 0 || state.strikes >= 3) && state.currentQuestion && (
        <div className="fixed top-0 left-0 bottom-0 right-0 bg-black/90 text-white flex justify-center items-center text-center">
          <div>
            {state.timeRemaining <= 0 && <p className="text-6xl mb-4 font-bold">Se acabo el tiempo!</p>}
            {state.strikes >= 3 && <p className="text-6xl mb-4 font-bold">3 Intentos Fallidos</p>}
            ...
            <p className="mb-5">La puntuacion mas alta: {state.highScore}</p>
